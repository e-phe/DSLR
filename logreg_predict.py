...
def parse():
    parser = argparse.ArgumentParser(
        description="Multi-classifier using logistic regression in one-vs-all. Predict with weights generated by the logreg_train",
    )
    parser.add_argument("dataset_test.csv", help="testing dataset")
    parser.add_argument("weights.csv", help="weight to make the prediction")
